...
import { LayoutDashboard, PawPrint, Dumbbell, FileText, MessageSquare, LogOut, CalendarDays, Menu, X, Camera, BookOpen } from 'lucide-react';
...
const navItems = [
  ...
  { to: '/portal/pautas',       label: 'Pautas',       icon: BookOpen },
